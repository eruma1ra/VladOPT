...
const valueBlocks = [
  ...
  },
  {
    ...
    text: "Работаем под заказ и регулярные поставки. Вы получаете табильные условия и понятную экономику.",
  },
  {
...
const steps = [
  ...
  {
    title: "Поставка",
    text: "После поступления оплаты на наш Р/C, отгружаем товар через согласованную транспортную компанию в течении 3-х рабочих дней.",
  },
];
